...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    blogStatus: Schema.Attribute.Enumeration<['Draft', 'Pending', 'Approved']> &
      Schema.Attribute.DefaultTo<'Draft'>;
    category: Schema.Attribute.Enumeration<
      ['Technology', 'Education', 'Lifestyle', 'Health']
    > &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'content'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    versions: Schema.Attribute.JSON;
  };
}
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    commentStatus: Schema.Attribute.Enumeration<['Pending', 'Approved']> &
